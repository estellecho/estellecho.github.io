...
### 2. Case Questions
  ...
  + List countries where customers have not placed orders and the number of such customers. 
  ...
  + Find the most expensive discontinued product with units in stock. 
