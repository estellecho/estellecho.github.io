...
**2) Anomaly Detection**
  ...
  +  Using advanced analytics techniques, potential anomalies have been identified and assigned fraud scores. Each case requires detailed exploration, with the highest-ranking records analyzed through [visual1](files/(P3) Highest ranking fraud owner.png), [visual2](files/(P3) Heatmap.png) and the [Excel](files/(P3) NY_top_lotsize_ne_0.xlsx) file output.
