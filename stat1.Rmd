...
![](https://img.shields.io/badge/-Financial%20Analysis-yellow)
  ...
  + **Model Exploration**: Logistic Regression, Decision Tree, Random Forest, LightGBM, CatBoost, and Neural Network. Each model, with its unique set of hyperparameters, was rigorously experimented to optimize performance and achieve balanced metrics.
